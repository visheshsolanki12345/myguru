          ...
          <div className="row">
            <div className="col-md-12">
              <div className="tab_menu">
                ...
                <div
                  id="owl-carousel-two"
                  className="career owl-carousel owl-theme"
                >
                  {/* <!--<div className="item">
                  ...
                  <div className="item">
                    <div className="newContent">
                      <div
                        className="youtube-video-place "
                        data-yt-url="7orpIslLZjE"
                      >
                        <i
            ...
            <div className="col-md-6 layout_padding_2">
              <div className="full">
                <div className="heading_main text_align_left">
                  <h2>
                    <span>Welcome To</span> My Guru
                  </h2>
                </div>
                <div className="full">
                  <p>
                    MyGuru is a online platform for guidance and counselling for
                    school / college students. By providing exhausting
                    information, numerous careers along with Industry Gurus
                    videos, this platform provide the tools required to make
                    connect choices in life and being successful. Tools are also
                    been provided for checking your well being a life skills
                    with specific guidance on how to be happen through improving
                    well being scores & how to be successful by improving life
                    skills course.
                  </p>
                </div>
                <div className="full">
                  <a className="hvr-radial-out button-theme" href="#">
                    About more
                  </a>
                </div>
              </div>
            ...
            <div className="col-md-6">
              <div className="full-leftImg">
                <img
                  className="img-fluid"
                  usemap="#workmap"
                  src="assets/images/dont-know.png"
                  alt=""
                />
                <map name="workmap">
                  <area shape="circle" coords="360,250,50" href="#" alt="" />{" "}
                  {/* what subject area */}
                  <area
                    shape="circle"
                    coords="50,310,80"
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="full d-flex">
                <div className="heading_main text_align_center">
                  <h2 className="mt-4 ml-lg-5 ml-sm-0 pl-5">
                    <span>Choose Your </span>Career
                  </h2>
                </div>
                <div className="float-end">
                  <a
                    className="hvr-radial-out button-theme"
                    href="vocational-career"
                  >
                    Vocational Career
                  </a>
                </div>
              ...
              <a href="innerpage.html">
                <div className="full blog_img_popular">
                  <img
                    ...
                    src="assets/images/career/p1.jpg"
                    alt="#"
                  />
                  <h4>ACTING</h4>
                </div>
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p2.jpg"
                  alt="#"
                />
                <h4>ACTUARY</h4>
              </div>
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p3.jpg"
                  alt="#"
                />
                <h4>ADVERTISING</h4>
              </div>
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p4.jpg"
                  alt="#"
                />
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p5.jpg"
                  alt="#"
                />
                <h4>ARMED FORCES</h4>
              </div>
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p6.jpg"
                  alt="#"
                />
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p7.jpg"
                  alt="#"
                />
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p8.jpg"
                  alt="#"
                />
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p9.jpg"
                  alt="#"
                />
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p10.jpg"
                  alt="#"
                />
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p11.jpg"
                  alt="#"
                />
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p12.jpg"
                  alt="#"
                />
                <h4>COMPUTERS</h4>
              </div>
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p13.jpg"
                  alt="#"
                />
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p14.jpg"
                  alt="#"
                />
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p15.jpg"
                  alt="#"
                />
                <h4>DENTISTRY</h4>
              </div>
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p16.jpg"
                  alt="#"
                />
                <h4>DESIGNING</h4>
              </div>
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p17.jpg"
                  alt="#"
                />
                <h4>ENGINEERING</h4>
              </div>
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p18.jpg"
                  alt="#"
                />
                <h4>FINE ARTS</h4>
              </div>
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p19.jpg"
                  alt="#"
                />
                <h4>JOURNALISM</h4>
              </div>
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p20.jpg"
                  alt="#"
                />
                <h4>MANAGEMENT</h4>
              </div>
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p21.jpg"
                  alt="#"
                />
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p22.jpg"
                  alt="#"
                />
                <h4>MEDICINE</h4>
              </div>
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p23.jpg"
                  alt="#"
                />
                <h4>MERCHANT NAVY</h4>
              </div>
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p24.jpg"
                  alt="#"
                />
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p25.jpg"
                  alt="#"
                />
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p26.jpg"
                  alt="#"
                />
                <h4>PHARMACY</h4>
              </div>
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p27.jpg"
                  alt="#"
                />
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p28.jpg"
                  alt="#"
                />
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p29.jpg"
                  alt="#"
                />
                <h4>SOCIAL WORKER</h4>
              </div>
            ...
            <div className="col-md-3">
              <div className="full blog_img_popular">
                <img
                  className="img-responsive"
                  src="assets/images/career/p30.jpg"
                  alt="#"
                />
                <h4>TOURISM</h4>
              </div>
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="full">
                <div className="heading_main text_align_center">
                  <h2>
                    <span>Don't </span>Know?
                  </h2>
                </div>
              </div>
              <div className="clearfix"></div>
              <div
                id="demo-owl-carousel"
                className="sliderH owl-carousel owl-theme"
              >
                <div className="item">
                  <div className="dontKnow">
                    ...
                    <h1>
                      Dont know what{" "}
                      <span>Subject to choose in Class 10th</span>
                    </h1>
                    <p>
                ...
                <div className="item">
                  <div className="dontKnow">
                    <div className="dontknowimg">
                      <img src="assets/images/dk2.png" />
                    </div>
                    <h1>
                      Check Your <span>Aptitude and Personality</span>
                    </h1>
                    <p>
                      Lorem ipsum, or lipsum as it is sometimes known, is dummy
                      text used in laying out print, graphic or web designs.
                ...
                <div className="item">
                  <div className="dontKnow">
                    <div className="dontknowimg">
                      <img src="assets/images/dk3.png" />
                    </div>
                    <h1>
                      Dont know what <span>Career to choose</span>
                    </h1>
                    <p>
                      Lorem ipsum, or lipsum as it is sometimes known, is dummy
                      text used in laying out print, graphic or web designs.
                ...
                <div className="item">
                  <div className="dontKnow">
                    <div className="dontknowimg">
                      <img src="assets/images/dk4.png" />
                    </div>
                    <h1>
                      Dont know how to <span>Improve Academic mark/Grade </span>
                    </h1>
                    <p>
                      Lorem ipsum, or lipsum as it is sometimes known, is dummy
                      text used in laying out print, graphic or web designs.
                ...
                <div className="item">
                  <div className="dontKnow">
                    <div className="dontknowimg">
                      <img src="assets/images/dk5.png" />
                    </div>
                    <h1>
                      Choose Your <span>Life Skills</span>
                    </h1>
                    <p>
                      Lorem ipsum, or lipsum as it is sometimes known, is dummy
                      text used in laying out print, graphic or web designs.
